  ...
  create  table "postgres"."dim"."test"
...
with refresh_date as (
    ...
    where table_name = '"postgres"."dim"."test"' and to_refresh = 1
),
max_rental_date as (
...
select 
    ...
    '2025-06-15 18:31:53.611128+00:00'::timestamp AT TIME ZONE 'UTC' as etl_time,
    '2025-06-15 18:31:53' as etl_time_str
